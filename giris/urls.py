...
urlpatterns = [
    ...
    url(r'^demirbas/proje/(?P<pk>\d+)/guncelle/$', views.demirbas_p_guncelle, name='demirbas_p_guncelle'),
    url(r'^demirbas/(?P<pk>\d+)/sil/kesin/$', views.demirbas_sil_kesin, name='demirbas_sil_kesin'),
    url(r'^demirbas/proje/(?P<pk>\d+)/sil/kesin/$', views.demirbas_p_sil_kesin, name='demirbas_p_sil_kesin'),
    url(r'^demirbas/(?P<pk>\d+)/sil/$', views.demirbas_sil, name='demirbas_sil'),
    url(r'^demirbas/proje/(?P<pk>\d+)/sil/$', views.demirbas_p_sil, name='demirbas_p_sil'),
